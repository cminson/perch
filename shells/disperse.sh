#!/bin/bash
#
# Developed by Fred Weinhaus 5/27/2008 .......... revised 2/11/2009
#
...
ww=`/usr/bin/convert $infile -format "%[fx:w]" info:`
hh=`/usr/bin/convert $infile -format "%[fx:h]" info:`
...
/usr/bin/convert $tmpA1 $tmp0 -monitor \
